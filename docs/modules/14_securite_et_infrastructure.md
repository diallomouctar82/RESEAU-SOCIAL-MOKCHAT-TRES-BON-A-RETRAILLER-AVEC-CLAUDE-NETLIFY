...
- **Partiel / En cours** : **SAT-5 (5 septembre 2026, DEC-2026-055)** — relance automatique bornée d'un direct gardée par l'état réel en base, et clôture horaire des directs zombies par `pg_cron` : code prouvé sur `claude/lives-directs-sat5`, migration NON appliquée, rien en production — la frontière VPS (conteneur, clé, ports, version) reste à SAT-6/ACT ; Authentification biométrique WebAuthn / Passkeys ; email/mot de passe réel (reporté, Google restait prioritaire).
