...
* **Preuves** : `tsc` 0 · **vitest 1192/1192 (84 fichiers)** après dix remises à
  niveau sur `main` (jusqu'à la PR #92) · `npm run build` propre · Green Gate
  **vert** sur `5960a70`, relancé sur le HEAD courant ·
