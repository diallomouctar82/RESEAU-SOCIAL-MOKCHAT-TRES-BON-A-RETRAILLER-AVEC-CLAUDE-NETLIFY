...
* **Preuves** : `tsc` 0 · **vitest 1248/1248 (87 fichiers)** après onze remises à
  niveau sur `main` (jusqu'à la PR #94) · `npm run build` propre · Green Gate
  **vert** sur `683bf88`, relancé sur le HEAD courant ·
