...
* **Statut** : 🟡 **PRÊTE POUR PRODUCTION CONTRÔLÉE** — PR à fusionner seule, après contrôle de `main` dans la minute ; vérification immédiate de `moknet.net` (bundle, morceau MediaPipe, modèles servis).
