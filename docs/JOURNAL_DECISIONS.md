...
* **Preuves** : `tsc` 0 · **vitest 950/950 (69 fichiers)** après deux remises à
  niveau sur `main` (PR #69 puis #73) · `npm run build` propre · Green Gate
  **vert** sur `50569af`, relancé sur le HEAD courant ·
