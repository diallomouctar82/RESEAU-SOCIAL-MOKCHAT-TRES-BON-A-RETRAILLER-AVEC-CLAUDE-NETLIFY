...
* **Statut** : 🟠 en prévisualisation de branche ; production contrôlée autorisée par la Direction sous condition « si tout est propre » (déploiement maîtrisé, vérification immédiate, retour à l'état stable sinon).
...
* **Preuves** : `tsc` 0 · **vitest 1577/1577 (102 fichiers)** après douze remises
  à niveau sur `main` (jusqu'à la PR #97) · `npm run build` propre · Green Gate
  **vert** sur `9180891`, relancé sur le HEAD courant ·
