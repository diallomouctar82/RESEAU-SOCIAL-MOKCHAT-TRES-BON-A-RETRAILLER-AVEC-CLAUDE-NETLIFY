...
**Référence** : DEC-2026-086 · branche `claude/stable-versions-restore-system-bobj0l` · PR #121 · statut 🟡 en préparation (PR brouillon ; production contrôlée seulement sur feu vert écrit de la Direction, une fois Green Gate vert, revue indépendante « PRÊT » et preuves versionnées).
