...
| **v6.40.2** | 5 Septembre 2026 | **Assistant IA Pré-Publication : sur téléphone, la modale passe au-dessus de la barre du bas — « Appliquer à ma publication » visible et cliquable, parcours complet jusqu'à la publication ; portail sur `<body>`, racine inerte, dialogue accessible, rien de retiré** | Réseau MOC (`components/AIPostAssistantModal.tsx`, bloc « ASSISTANT IA » d'`index.html`) | branche `claude/cleanup-home-interface-szp8qv` / DEC-2026-080 / PR brouillon | **Prête, non déployée — feu vert écrit attendu** : typage 0 erreur, 1596/1596 tests (105 fichiers), build OK, parcours avant/après sur 390 × 844, 360 × 800 et 1440 × 900 (`docs/captures/2026-09-05-assistant-ia-modale-dock/`) |
...
### [Version 6.40.2] — 5 Septembre 2026 (Assistant IA Pré-Publication : « Appliquer à ma publication » au-dessus du dock sur téléphone) — PRÊTE, NON DÉPLOYÉE
...
* **Preuves** : typage 0 erreur, 1596/1596 tests (105 fichiers, 7 nouveaux),
