...
**Preuves** : typage 0, 1 658/1 658 tests (109 fichiers), build propre ; banc navigateur sur le build de la branche : banc en cours au moment de ce commit — résultats, planches et mesures consignés par le commit de preuves suivant ; revue indépendante en cours (agent séparé, producteur ≠ contrôleur), verdict consigné au cycle suivant.
