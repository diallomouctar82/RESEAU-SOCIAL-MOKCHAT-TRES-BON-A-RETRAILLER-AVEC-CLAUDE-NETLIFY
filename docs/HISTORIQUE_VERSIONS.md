...
- **Revue indépendante** (contrôleur séparé) : « À CORRIGER » sur `50f481c` — 2 IMPORTANT, 9 MINEUR — tous traités dans `c396623` (voir DEC-2026-085) ; contre-vérification en cours. La sculpture ouverte ne referme plus (« Parler à l'Architecte » ; fermer = ✕) : à contrôler par la Direction.
