...
| **v6.42.2** | 5 Septembre 2026 | **Assistant IA Pré-Publication : le panneau reste toujours dans l'écran sur téléphone — champ du composeur à 16 px sur tactile (plus de zoom automatique iOS), voile qui suit la zone visible (zoom, clavier), carte 90 % / 96 % du voile, parties fixes jamais écrasées, en-tête et pied repliables, rien de retiré** | Réseau MOC (`components/AIPostAssistantModal.tsx`, blocs « ASSISTANT IA » et « COMPOSEUR A7 — CHAMP A 16 PX » d'`index.html`) | branche `claude/cleanup-home-interface-szp8qv` / DEC-2026-082 / PR brouillon | **Prête, non déployée — feu vert écrit attendu** : typage 0 erreur, 1645/1645 tests (109 fichiers), build OK, sonde sur neuf cas avant/après et parcours complet (`docs/captures/2026-09-05-assistant-ia-taille-telephone/`) |
...
### [Version 6.42.2] — 5 Septembre 2026 (Assistant IA Pré-Publication : le panneau reste toujours dans l'écran sur téléphone) — PRÊTE, NON DÉPLOYÉE
...
* **Comment** : composant (`ia-tete`, `ia-onglets`, `ia-corps`, `ia-pied`,
  ...
  du composeur à 16 px sur `pointer: coarse` ou ≤ 767 px). DEC-2026-082.
