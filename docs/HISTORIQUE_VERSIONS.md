...
- Tests : `tests/sessionValidee.test.ts` (11), `tests/appEntreeReseau.test.tsx` (+12, dont le rejeu `SIGNED_IN` et la course avec une déconnexion), `tests/netlifyRedirectsCanoniques.test.ts` (6).
