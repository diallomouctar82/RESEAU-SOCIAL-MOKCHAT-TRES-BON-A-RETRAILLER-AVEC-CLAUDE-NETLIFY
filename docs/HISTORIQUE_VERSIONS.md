...
| **v6.41.2** | 5 Septembre 2026 | **Architecte : plus de bande sombre au sommet du cadre rond de `/architecte` — le moteur de cadrage comble le débord d'une photo trop serrée par un prolongement adouci du fond (et le signale à l'Admin-Général) ; portrait d'usine, affiche et vidéo HeyGen régénérés sans nouveau crédit** | Diallo OS & Architecte (module 01) : moteur photo (`photoAvatarEngine.ts`, `photoAvatar.ts`), `public/architecte/`, registre des séquences ; Super-Admin (avertissement de l'option « depuis une photo ») | branche `claude/moknet-studio-avatar-rjvvip` / DEC-2026-079 (ajustement) | **En cours de production contrôlée** (feu vert de la Direction : « tu montres une preuve avant-après sur mobile et ordi, puis seulement après tu mets en production contrôlée ») : typage 0 erreur, 1598/1598 tests (104 fichiers), build ✓ ; captures avant/après sur trois écrans (`docs/captures/2026-09-05-architecte-bande-sombre/`), luminance de la bande 0 → 131–137 (portrait) et 0 → 125–131 (vidéo) ; fusion, bundle et vérification de `moknet.net` consignés par la PR de mémoire vivante suivante |
...
### [Version 6.41.2] — 5 Septembre 2026 (Architecte : plus de bande sombre au sommet du cadre rond) — EN COURS DE PRODUCTION CONTRÔLÉE
...
- **Preuves** : typage 0, 1598/1598 tests (104 fichiers), build ✓ ; `docs/captures/2026-09-05-architecte-bande-sombre/` (captures avant/après ordinateur, tablette, téléphone, au repos et vidéo en lecture ; mesures de luminance de la bande 0 → 131–137 ; planche portrait / silhouettes ; empreintes ; captures de production « avant » à 16:04 UTC).
