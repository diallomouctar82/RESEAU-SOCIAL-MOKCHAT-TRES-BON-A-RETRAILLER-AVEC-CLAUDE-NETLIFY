...
> *Version Courante : v6.19.0 (**SAT-4 EN PRODUCTION CONTRÔLÉE — LA SANTÉ GLOBALE SAIT DÉSORMAIS SI UN DIRECT PEUT VRAIMENT DÉMARRER : FONCTION EDGE `health-guardian` v2 DÉMONTRÉE, LIGNE CLIENT SERVIE PAR `moknet.net` DEPUIS LE 5/09 (PR #77)** ; « RÉSEAU MOC » SOUS « ACCUEIL », CONTOURS DES ZONES DE SAISIE RENFORCÉS, NOUVELLE INVITE DU COMPOSEUR — PRODUCTION CONTRÔLÉE ; BARRE LATÉRALE D’« ACCUEIL » À « CONSEIL DES SAGES » ; ACCUEIL NETTOYÉ — SIX DÉCLENCHEURS RETIRÉS DE L'AFFICHAGE, AUCUNE FONCTION SUPPRIMÉE, VALIDÉ PAR LA DIRECTION ; MENU « MIROIR D'EAU » + STUDIO LIVE « ABYSSE » **EN PRODUCTION SUR `moknet.net`, VALIDÉS PAR LA DIRECTION** ; MENUS DE L'EN-TÊTE RÉPARÉS ; APPELS AUDIO/VIDÉO RÉELS, TRADUITS VOIX À VOIX, SONNERIE FIABLE APPLI FERMÉE, SÉCURITÉ BASE RENFORCÉE ; **SATURATION DES DIRECTS : CODE CLIENT EN PRODUCTION ET FONCTION EDGE EN VERSION 7, MAIS ENCORE DÉLIBÉRÉMENT INERTE** — voir plus bas)*
