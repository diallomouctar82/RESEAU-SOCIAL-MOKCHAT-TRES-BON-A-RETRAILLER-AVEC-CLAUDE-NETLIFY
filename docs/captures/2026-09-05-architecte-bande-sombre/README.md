...
Tests sur l'arbre livré : typage 0 erreur, **1640 / 1640** tests (108 fichiers), build ✓ — dont `tests/photoAvatar.test.ts` (bandes de débord, géométrie des tuiles), `tests/architecteSequences.test.ts` (empreintes des vidéos) et `tests/architecteAssets.test.ts` (empreintes du portrait, de la silhouette et de l'affiche).
