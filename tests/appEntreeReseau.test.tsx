...
const h = vi.hoisted(() => ({
    ...
    // Verrou d'entrée (DEC-2026-080) : verdict du serveur sur une session relue
...
describe("Verrou d'entrée — accès public réservé aux sessions valides (Direction, 05/09/2026, DEC-2026-080)", () => {
