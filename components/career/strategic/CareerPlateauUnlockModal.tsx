            ...
            {!unlockedState ? (
              <div className="pt-2 flex items-center justify-between flex-wrap gap-3">
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs md:text-sm rounded-xl transition-all shadow-lg shadow-blue-600/20 flex items-center gap-2"
                >
                  <Unlock size={16} />
