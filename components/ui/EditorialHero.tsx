...
export const EditorialHero: React.FC<EditorialHeroProps> = ({
  ...
  return (
    <div className="bg-slate-900 text-white rounded-3xl p-6 sm:p-10 relative overflow-hidden shadow-xl border border-slate-800">
      {/* Background ambient lighting - strictly controlled deep navy & subtle warm tone */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-bl from-orange-600/10 via-blue-600/10 to-transparent rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-100 via-orange-200 to-white">
          ...
          <div className="pt-2">
            ...
            >
              <div className="w-8 h-8 rounded-xl bg-orange-600 text-white flex items-center justify-center font-bold text-xs shrink-0 shadow-sm">
                Cap
              </div>
              <div className="truncate text-left">
                <div className="text-[11px] font-semibold text-slate-400 flex items-center gap-1">
                  ...
                  <span className="text-orange-400 group-hover:underline">Changer de cap</span>
                </div>
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className="bg-gradient-to-b from-white/15 to-white/5 border border-white/15 rounded-2xl p-5 backdrop-blur-md shadow-lg">
            ...
            <button
              ...
              className="w-full bg-orange-600 hover:bg-orange-500 text-white px-4 py-3 rounded-xl font-bold text-sm transition-all shadow-md flex items-center justify-center gap-2 group"
            >
