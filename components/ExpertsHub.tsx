...
export const ExpertsHub: React.FC<ExpertsHubProps> = ({ userProfile, initialTab = 'catalogue', onNavigate }) => {
    ...
    return (
        <div className="flex flex-col h-full bg-slate-100 overflow-hidden">
            ...
            <div className="bg-white border-b border-slate-200/80 px-4 sm:px-6 py-3.5 flex flex-col md:flex-row justify-between items-start md:items-center gap-3 shrink-0 shadow-xs z-10">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-blue-700 text-white flex items-center justify-center shadow-md shadow-blue-500/20">
                        <Users size={20} />
                    </div>
                    <div>
                        <h1 className="text-base sm:text-lg font-black text-slate-900 flex items-center gap-2">
                            <span>Espace Experts & Parcours de Vie</span>
                        </h1>
                        <p className="text-xs text-slate-500 font-medium">
                            Accompagnement continu, mémoire active et coordination multi-experts Diallo OS
                        </p>
                    </div>
                </div>
