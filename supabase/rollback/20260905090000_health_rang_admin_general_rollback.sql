-- Retour arrière de 20260905090000_health_rang_admin_general.sql : rejoue la
-- version précédente de health_probe_catalogue() (celle de
-- 20260904150000_health_guardian.sql), sans les compteurs superAdminCount /
-- adminCount. Aucun droit, aucune donnée touchée dans un sens comme dans
-- l'autre. Après ce retour, la ligne « gouvernance.rang_admin_general »
-- redevient blanche (non mesurée) — jamais verte.
